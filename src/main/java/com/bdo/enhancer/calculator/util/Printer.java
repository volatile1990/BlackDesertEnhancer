package com.bdo.enhancer.calculator.util;
...
public class Printer {
    ...
    public void printComprehensiveTable(List<AccessoryEnhancementResult> results) {
    ...
    private String getBestEnhancementLevel(AccessoryEnhancementResult result) {
    ...
    public void printDetailedAnalysisByLevel(List<AccessoryEnhancementResult> results) {
    ...
    public void printLevelSpecificTable(List<AccessoryEnhancementResult> results, String title, String levelColor) {
