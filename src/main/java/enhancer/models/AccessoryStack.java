...
public enum AccessoryStack {
	...
	FOURTYFIVE(406, 83.5, 51, 40.65, 13.75), SIXTY(1540, 90, 54, 42.9, 17.5), SIXTY_FREE(0, 90, 54, 43.5, 17.5), SEVENTY_FREE(0, 90, 56, 45, 20), EIGHTY_FREE(0, 90, 58, 46.5, 22.5), NINETY_FREE(0, 90, 60, 48, 25),
